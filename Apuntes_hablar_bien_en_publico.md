...
Elemento fundamental de la oralidad. Tiene una flexibilidad y complejidad enormes. Se encuentra llena de matices relacionadas con la intuición. 

> En la comunicación oral el instrumento más importante es la **modulación de la voz**

No se puede elegir el tipo de voz que tenemos, pero si que podemos aprender a regular la potencia de emisión, calcular los silencios y, en definitiva, generar un vehículo sonoro que conforte a la audiencia.

Debemos **dominar la voz**. Manejar su intensidad, su ritmo y su entonación para ayudarnos a modelar el discurso que le de mayor efecto para conseguir comunicar con éxito.

Hay dos aspectos fundamentales para llegar a captar la atención y generar interes: Energía y vitalidad. No hay una música del agrado de todo el mundo, pero si cada uno se muestra como es y al mismo tiempo demuestra su mejor canción, tiene más posibilidades de llegar al alma de los oyentes.

Debemos modular la voz de forma que acceda mejor al público con una determinada entonación, volumen y ritmo.

### Sobre el volumen

Es necesario en una presentación que se oiga bien lo que se dice. Para esto, el volumen no debe de ser ni demasiado alto ni demasiado bajo.
